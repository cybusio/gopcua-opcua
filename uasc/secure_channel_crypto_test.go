...
// REQ-PROD-0012: when a UserTokenPolicy advertises an empty
// SecurityPolicyURI (per OPC UA Part 4 §7.36 — "inherit channel
// policy"), the client's encrypted UserName token construction must
// fall back to the SecureChannel's negotiated SecurityPolicyURI. This
// test pins that contract end-to-end: the encrypted password produced
// with policyURI="" on a Basic256Sha256 channel matches the encrypted
// password produced with policyURI=Basic256Sha256, and the returned
