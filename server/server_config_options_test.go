...
func TestResourcePathAppendsToEndpoints(t *testing.T) {
	cases := []struct {
		...
		{"plain", "UA/CybusOpcuaServer", "/UA/CybusOpcuaServer"},
		{"leading-slash", "/UA/CybusOpcuaServer", "/UA/CybusOpcuaServer"},
		{"trailing-slash", "/UA/CybusOpcuaServer/", "/UA/CybusOpcuaServer"},
		{"double-leading", "//UA/CybusOpcuaServer", "/UA/CybusOpcuaServer"},
